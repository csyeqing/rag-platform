...
class RetrievalProfileConfig(BaseModel):
    ...
    vector_candidate_multiplier: int = Field(default=4, ge=2, le=20)
    keyword_candidate_multiplier: int = Field(default=4, ge=2, le=20)
    graph_candidate_multiplier: int = Field(default=5, ge=2, le=24)
