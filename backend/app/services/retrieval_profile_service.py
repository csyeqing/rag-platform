...
def build_runtime_retrieval_config(overrides: dict | None, settings: Settings | None = None) -> dict:
    ...
    return {
        ...
        'vector_candidate_multiplier': _as_int(base.get('vector_candidate_multiplier'), fallback=4, lower=2, upper=20),
        'keyword_candidate_multiplier': _as_int(base.get('keyword_candidate_multiplier'), fallback=4, lower=2, upper=20),
        'graph_candidate_multiplier': _as_int(base.get('graph_candidate_multiplier'), fallback=5, lower=2, upper=24),
